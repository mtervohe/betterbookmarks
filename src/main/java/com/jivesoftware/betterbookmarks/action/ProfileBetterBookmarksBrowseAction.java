...
public class ProfileBetterBookmarksBrowseAction extends BookmarksBrowseAction {
    ...
    public void setProfileBookmarksBrowseViewBean(BookmarksViewBean profileBookmarksBrowseViewBean) {
        //System.out.println("setProfileBookmarksBrowseViewBean in ProfileBetterBookmarksBrowseAction");
    ...
    public String execute() {
        ...
        log.info("ProfileBetterBookmarksBrowseAction called execute");
        model = getBrowseActionSupport().getPopulatedBrowseViewBean();
        return SUCCESS;
    }

    public String doAdd(){
        System.out.println("ProfileBetterBookmarksBrowseAction called add");
        return "SUCCESS";
    }
